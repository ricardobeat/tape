...
| [022-property-descriptor-correctness.md](022-property-descriptor-correctness.md) | 🔶 IN PROGRESS | Session 163: NEW_OBJ lightfunc constructable check (+170 net); Session 162: ToString exponential notation fix (+67 net); Bugs A & C already fixed (seal/freeze dense arrays, GOPD flags) |
