...
**Last Updated:** Session 133 (MOD -0 sign fix + quick.sh assert.js harness)
**Target:** 80% test262 pass rate on ES5/ES6 core

## Summary (after Session 133, 2026-06-07)
...
| Currently passing | ~8,058 |
| Currently failing | ~13,457 |
| Pass rate (of run) | ~37% |
...
|---|---|---|---|---|---|
| 0-1: Core VM | 2,185 | 510 | 378 | 1,297 | VM, lexer, compiler ✅ |
| 1: Calling Convention | 426 | 35 | 53 | 338 | Most skipped (noStrict) |
| 2: Basic Operators | 1,969 | 910 | 234 | 825 | +38 from MOD -0 fix |
...
| 6: Prototype Methods | 4,713 | 1,050 | 2,727 | 936 | +23 from pushback fix |
| 7: ES5 Features | 1,240 | 177 | 116 | 947 | +17 from pushback fix |
| 8: ES5 Built-in Objects | 2,747 | 563 | 721 | 1,463 | RegExp proto chain ✅ |
