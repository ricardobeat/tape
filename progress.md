...
**Last Updated:** Session 137 (builtin method writable flags + defineProperty accessor→data)
**Target:** 80% test262 pass rate on ES5/ES6 core

## Summary (after Session 137, 2026-06-07)
...
| Currently passing | ~9,041 |
| Currently failing | ~12,475 |
| Pass rate (of run) | ~42.0% |
...
|---|---|---|---|---|---|
| 0-1: Core VM | 2,185 | 533 | 355 | 1,297 | +22 from catch PUTVAR fix |
| 1: Calling Convention | 426 | 46 | 42 | 338 | +11 from catch PUTVAR fix |
| 2: Basic Operators | 1,969 | 944 | 200 | 825 | +20 from catch PUTVAR fix |
| 3: Object System | 7,766 | 2,296 | 3,503 | 1,967 | **+229** from catch PUTVAR fix |
| 4: Error Handling | 402 | 83 | 118 | 201 | +4 from catch PUTVAR fix |
| 5: Built-in Constructors | 8,615 | 2,799 | 4,291 | 1,525 | **+258** from catch PUTVAR fix |
| 6: Prototype Methods | 4,713 | 1,141 | 2,636 | 936 | **+81** from catch PUTVAR fix |
| 7: ES5 Features | 1,240 | 182 | 111 | 947 | +5 from catch PUTVAR fix |
| 8: ES5 Built-in Objects | 2,747 | 607 | 677 | 1,463 | +46 from catch PUTVAR fix |
