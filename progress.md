...
| Currently passing | ~8,083 |
| Currently failing | ~13,432 |
| Pass rate (of run) | ~37% |
...
|---|---|---|---|---|---|
| 0-1: Core VM | 2,185 | 511 | 377 | 1,297 | +1 from needs_restart fix |
| 1: Calling Convention | 426 | 35 | 53 | 338 | Most skipped (noStrict) |
| 2: Basic Operators | 1,969 | 924 | 220 | 825 | +14 from needs_restart fix |
| 3: Object System | 7,766 | 2,067 | 3,732 | 1,967 | defineProperty SameValue ✅ |
| 4: Error Handling | 402 | 79 | 122 | 201 | Error names fixed |
| 5: Built-in Constructors | 8,615 | 2,541 | 4,549 | 1,525 | +32 from pushback fix |
| 6: Prototype Methods | 4,713 | 1,060 | 2,717 | 936 | +10 from needs_restart fix |
| 7: ES5 Features | 1,240 | 177 | 116 | 947 | +17 from pushback fix |
| 8: ES5 Built-in Objects | 2,747 | 561 | 723 | 1,463 | -2 timeout noise |
