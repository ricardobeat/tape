...
- [x] **Strict-only Phase B** — KEEP direct-eval machinery (`ACT_FLAG_DIRECT_EVAL`, `has_direct_eval`, `callee_is_eval`, `global.c3:213`): direct eval is valid in strict mode, must not be removed
